...
<body>
  <div class="main-page py-2 text-center d-flex flex-column flex-fill" style="background-image: url('/assets/images/bg_daftar.png');	width: 100%;	background-size: cover;	background-position: center;	background-repeat: no-repeat; background-attachment: fixed;">
          ...
          <div class="col-lg col-10 bg-white p-3 mx-5 shadow-lg">
            <div class="row">
              <div class="px-0 col-md-1 py-2">
                <img src="/assets/images/thumbnail_daftar.png" class="img-responsive img-thumbnail shadow-sm" width="77">
              </div>
              <div class="col-md-0">
            ...
            <p class="mb-3 text-left">Sudah punya akun? <a href="login">Masuk</a></p>
            ...
            <script>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  <label for="nope">Nomor Telefon</label>
                  <input type="number" class="form-control" id="nope" name="nope" placeholder="Cth: 081234567890" required="required">
                </div>
              </div>
              <div class="form-group">
