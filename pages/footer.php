      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-6 p-3">
            ...
            <ul class="list-unstyled">
              <li> <a href="/">Beranda</a> </li>
              <li> <a href="../views/stilldev">Galeri</a> </li>
              <li> <a href="../views/stilldev">Berita</a> </li>
            </ul>
          </div>
          ...
          <div class="col-lg-3 col-6 p-3">
            <h5> <b>Informasi Bantuan</b> </h5>
            <ul class="list-unstyled">
              <li> <a href="../views/stilldev">Pertanyaan Yang Sering Diajukan</a> </li>
              <li> <a href="../views/stilldev">Daftar Pustakawan</a> </li>
              <li> <a href="../views/stilldev">Ruang Perpustakaan</a> </li>
            </ul>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <p class="mb-0 mt-2">© <?php echo date("Y"); ?> RMPPL. All rights reserved</p>
          </div>
        </div>
      </div>
    </div>
